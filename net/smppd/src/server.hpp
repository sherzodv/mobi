...
class server: public service<ProtoT, AllocatorT, LogT> {
	...
	protected:
		...
		void on_unbind_r(bin::sz_t channel_id, const unbind_r & msg) {
			lerror(L) << channel_id << "got unbind_r: " << msg;
		}
};
