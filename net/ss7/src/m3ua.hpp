...
namespace mobi { namespace net { namespace ss7 { namespace m3ua {
	...
	std::string to_string(service_indicator si) {
		...
		switch (si) {
			...
			case si_sattelite:
				...
				break;
			default:
				out << "unknown:" << static_cast<unsigned>(si);
				break;
		}
		out << "]";
		return out.str();
	...
	std::string to_string(parameter_tag t) {
		...
		out << "[tag:";
		switch (t) {
			case tag_info_string:
				out << "info_string";
				break;
			case tag_routing_ctxt:
				out << "routing_ctxt";
				break;
			case tag_diagnostics:
				out << "diagnostics";
				break;
			case tag_heartbeat:
				out << "heartbeat";
				break;
			case tag_traf_mode_type:
				out << "traf_mode_type";
				break;
			case tag_error_code:
				out << "error_code";
			...
			case tag_correlation_id:
				...
				break;
			case tag_network_appearance:
				out << "network_appearance";
				break;
			case tag_user_cause:
				out << "user_cause";
				break;
			case tag_cong_indications:
				out << "cong_indications";
				break;
			case tag_concerned_dst:
				out << "concerned_dst";
				break;
			case tag_routing_key:
				out << "routing_key";
				break;
			case tag_reg_result:
				out << "reg_result";
				break;
			case tag_dereg_result:
				out << "dereg_result";
				break;
			case tag_local_routing_key_id:
				out << "local_routing_key_id";
				break;
			case tag_dst_point_code:
				out << "dst_point_code";
				break;
			case tag_service_indicators:
				out << "service_indicators";
				break;
			case tag_orig_point_code_list:
				out << "orig_point_code_list";
				break;
			case tag_protocol_data:
				out << "protocol_data";
				break;
	...
	std::string to_string(message_class mc) {
		...
		switch (mc) {
			case mclass_mgmt:
				out << "mgmt";
				break;
			case mclass_transfer:
				out << "transfer";
				break;
			case mclass_ss7_mgmt:
				out << "ss7mgmt";
				break;
			case mclass_asp_state:
				out << "aspstate";
				break;
			case mclass_asp_traffic:
				out << "asptraf";
				break;
			case mclass_route_mgmt:
				out << "routemgmt";
				break;
			default:
				out << "unknown";
	...
	std::string to_string(mtype::mgmt mt) {
		std::stringstream out;
		switch (mt) {
			case mtype::mgmt_error:
				out << "mgmt_error";
				break;
			case mtype::mgmt_notify:
				out << "mgmt_notify";
				break;
			default:
				out << "mgmt:unknown";
	...
	std::string to_string(mtype::ss7_mgmt mt) {
		std::stringstream out;
		switch (mt) {
			case mtype::ss7_mgmt_duna:
				out << "ss7mgmt_DUNA";
				break;
			case mtype::ss7_mgmt_dava:
				out << "ss7mgmt_DAVA";
				break;
			case mtype::ss7_mgmt_daud:
				out << "ss7mgmt_DAUD";
				break;
			case mtype::ss7_mgmt_scon:
				out << "ss7mgmt_SCON";
				break;
			case mtype::ss7_mgmt_dupu:
				out << "ss7mgmt_DUPU";
				break;
			case mtype::ss7_mgmt_drst:
				out << "ss7mgmt_DRST";
				break;
			default:
				out << "ss7mgmt:unknown";
	...
	std::string to_string(mtype::asp_state mt) {
		std::stringstream out;
		switch (mt) {
			case mtype::asp_state_up:
				out << "aspstate_UP";
				break;
			case mtype::asp_state_down:
				out << "aspstate_DOWN";
				break;
			case mtype::asp_state_hb:
				out << "aspstate_HB";
				break;
			case mtype::asp_state_up_ack:
				out << "aspstate_UPACK";
				break;
			case mtype::asp_state_down_ack:
				out << "aspstate_DOWNACK";
				break;
			case mtype::asp_state_hb_ack:
				out << "aspstate_HBACK";
				break;
			default:
				out << "aspstate:unknown";
				break;
		}
		return out.str();
	}
	...
	std::string to_string(mtype::asp_traf mt) {
		std::stringstream out;
		switch (mt) {
			case mtype::asp_traf_active:
				out << "asptraf_ACTIVE";
				break;
			case mtype::asp_traf_inactive:
				out << "asptraf_INACTIVE";
				break;
			case mtype::asp_traf_active_ack:
				out << "asptraf_ACTIVEACK";
				break;
			case mtype::asp_traf_inactive_ack:
				out << "asptraf_INACTIVEACK";
				break;
			default:
				out << "asptraf:unknown";
				break;
	...
	std::string to_string(mtype::asp_route mt) {
		std::stringstream out;
		switch (mt) {
			case mtype::asp_route_reg_req:
				out << "asproute_REGREQ";
				break;
			case mtype::asp_route_reg_rsp:
				out << "asproute_REGRSP";
				break;
			case mtype::asp_route_dereg_req:
				out << "asproute_DEREGREQ";
				break;
			case mtype::asp_route_dereg_rsp:
				out << "asproute_DEREGRSP";
				break;
			default:
				out << "asproute:unknown";
				break;
		}
		return out.str();
	}
