...
namespace ba = boost::asio;
	...
	/*
	 * ImplT should provide following member functions:
	 *
	 * void on_register() = 0;
	 * void on_message(peer_t *p, msgu * msg) = 0;
	 * void on_send_message(const bs::error_code & ec, size_t bytes) = 0;
	 *
	 */
...
class client_base {
	...
	public:
		...
		void send_message(const msgu * msg) {
			send(&client_base::on_send_message, msg);
		}
